        ...
        <div class="w-full max-w-4xl bg-white shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-2xl flex overflow-hidden">
            ...
            <div class="w-1/2 bg-[#00B4D8] p-12 flex flex-col items-center justify-center text-white relative overflow-hidden">
                ...
                <div class="relative z-10 text-center">
                    ...
                    <p class="mt-4 text-sm text-white/80 max-w-sm mx-auto">
                        Daftar sekarang dan nikmati kemudahan layanan laundry kami!
                    </p>
                </div>
            </div>
            ...
            <div class="w-1/2 p-12">
                <div class="mb-8">
                    ...
                    <p class="mt-2 text-gray-600">Silakan lengkapi data diri Anda</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600">
                            Sudah punya akun?
                            <a href="{{ route('login') }}" class="font-medium text-[#00B4D8] hover:text-[#0096B4] transition-colors duration-200">
                                Masuk sekarang
                            </a>
                        </p>
                    </div>
